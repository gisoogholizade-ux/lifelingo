...
const sourceFiles=['v66.html','v66-app.js','v67-nav-bridge.js','v67-speak-fix.js','v69-avatar-system.js','avatar-legacy-recovery.js','lifelingo-auth-fix.js','lifelingo-frontend-stabilize.js'];
...
const result={enKeys:en.size,faKeys:fa.size,missingFa,missingEn,legacyNavigationCandidates:legacy,hardcodedUiCandidates:suspicious.length};
