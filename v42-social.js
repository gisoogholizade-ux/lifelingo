...
const faceStyle=i=>{const a=typeof i==='object'?i:byId(i);return `background-image:url('${a.src}?v=avatar2');background-size:cover;background-position:center;background-repeat:no-repeat;background-color:#0b1120`};
const face=(i,cls='')=>{const a=typeof i==='object'?i:byId(i);return `<img class="ll43Face ${cls}" src="${a.src}?v=avatar2" alt="LifeLingo avatar" loading="eager" decoding="async">`};
